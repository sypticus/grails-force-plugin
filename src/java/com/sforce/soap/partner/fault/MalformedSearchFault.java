 ...
 */
            ...
            /**
            *  MalformedSearchFault bean class
            */
        ...
        /* This type was generated from the piece of schema that had
                ...
                Namespace URI = urn:fault.partner.soap.sforce.com
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       MalformedSearchFault.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":MalformedSearchFault",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                                           ...
                                           localExceptionCode.serialize(new javax.xml.namespace.QName("urn:fault.partner.soap.sforce.com","exceptionCode"),
                                               factory,xmlWriter);
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("urn:fault.partner.soap.sforce.com","MalformedSearchFault"));
                
                            elementList.add(new javax.xml.namespace.QName("urn:fault.partner.soap.sforce.com",
                                                                      "exceptionCode"));
    ...
    public static class Factory{
        ...
        */
        public static MalformedSearchFault parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            MalformedSearchFault object =
                new MalformedSearchFault();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"MalformedSearchFault".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (MalformedSearchFault)com.sforce.soap.partner.sobject.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                while(!reader.isEndElement()) {
                    if (reader.isStartElement() ){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:fault.partner.soap.sforce.com","exceptionCode").equals(reader.getName())){
                                
                                                object.setExceptionCode(com.sforce.soap.partner.fault.ExceptionCode.Factory.parse(reader));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:fault.partner.soap.sforce.com","exceptionMessage").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:fault.partner.soap.sforce.com","row").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:fault.partner.soap.sforce.com","column").equals(reader.getName())){
