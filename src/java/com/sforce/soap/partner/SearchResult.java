 ...
 */
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        /**
                        * field for SearchRecords
                        * This was an Array!
                        */

                        
                                    protected com.sforce.soap.partner.SearchRecord[] localSearchRecords ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           * @return com.sforce.soap.partner.SearchRecord[]
                           */
                           public  com.sforce.soap.partner.SearchRecord[] getSearchRecords(){
                               return localSearchRecords;
                           }
                              ...
                              /**
                               * validate the array for SearchRecords
                               */
                              protected void validateSearchRecords(com.sforce.soap.partner.SearchRecord[] param){
                              ...
                              * @param param SearchRecords
                              */
                              public void setSearchRecords(com.sforce.soap.partner.SearchRecord[] param){
                              
                                   validateSearchRecords(param);

                               
                                          if (param != null){
                                             //update the setting tracker
                                             localSearchRecordsTracker = true;
                                          } else {
                                             localSearchRecordsTracker = false;
                                                 
                                          }
                                      
                                      this.localSearchRecords=param;
                              }
                             ...
                             * @param param com.sforce.soap.partner.SearchRecord
                             */
                             public void addSearchRecords(com.sforce.soap.partner.SearchRecord param){
                                   if (localSearchRecords == null){
                                   localSearchRecords = new com.sforce.soap.partner.SearchRecord[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localSearchRecords);
                               list.add(param);
                               this.localSearchRecords =
                             (com.sforce.soap.partner.SearchRecord[])list.toArray(
                            new com.sforce.soap.partner.SearchRecord[list.size()]);
                                       ...
                                       if (localSearchRecords!=null){
                                            for (int i = 0;i < localSearchRecords.length;i++){
                                                if (localSearchRecords[i] != null){
                                                 localSearchRecords[i].serialize(new javax.xml.namespace.QName("urn:partner.soap.sforce.com","searchRecords"),
                                                           factory,xmlWriter);
                                                } else {
                                 ...
                                 for (int i = 0;i < localSearchRecords.length;i++){
                                    ...
                                    if (localSearchRecords[i] != null){
                                         elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com",
                                                                          "searchRecords"));
                                         elementList.add(localSearchRecords[i]);
                                    } else {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"SearchResult".equals(type)){
                                ...
                                return (SearchResult)com.sforce.soap.partner.sobject.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:partner.soap.sforce.com","searchRecords").equals(reader.getName())){
                                
                                    
                                    
                                    // Process the array and step past its final element's end.
                                    list1.add(com.sforce.soap.partner.SearchRecord.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone1){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("urn:partner.soap.sforce.com","searchRecords").equals(reader.getName())){
                                                                    list1.add(com.sforce.soap.partner.SearchRecord.Factory.parse(reader));
                                                        ...
                                                        object.setSearchRecords((com.sforce.soap.partner.SearchRecord[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                com.sforce.soap.partner.SearchRecord.class,
                                                                list1));
