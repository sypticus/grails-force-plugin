 ...
 */
            ...
            /**
            *  PicklistForRecordType bean class
            */
        
        public  class PicklistForRecordType
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = PicklistForRecordType
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        /**
                        * field for PicklistName
                        */

                        
                                    protected java.lang.String localPicklistName ;
                           ...
                           */
                           public  java.lang.String getPicklistName(){
                            ...
                            /**
                               ...
                               * @param param PicklistName
                               */
                               public void setPicklistName(java.lang.String param){
                            
                                            this.localPicklistName=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       PicklistForRecordType.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":PicklistForRecordType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"picklistName", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"picklistName");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("picklistName");
                                    }
                                

                                          if (localPicklistName==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("picklistName cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localPicklistName);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com",
                                        ...
                                        if (localPicklistName != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localPicklistName));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("picklistName cannot be null!!");
                                        }
                                     if (localPicklistValuesTracker){
    ...
    public static class Factory{
        ...
        */
        public static PicklistForRecordType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            PicklistForRecordType object =
                new PicklistForRecordType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"PicklistForRecordType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (PicklistForRecordType)com.sforce.soap.partner.sobject.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list2 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:partner.soap.sforce.com","picklistName").equals(reader.getName())){
                                
                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setPicklistName(
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list2.add(com.sforce.soap.partner.PicklistEntry.Factory.parse(reader));
                                                                }
