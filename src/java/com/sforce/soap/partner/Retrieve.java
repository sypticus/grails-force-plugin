        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected com.sforce.soap.partner.ID[] localIds ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  com.sforce.soap.partner.ID[] getIds(){
                               return localIds;
                           }
                               ...
                               */
                              protected void validateIds(com.sforce.soap.partner.ID[] param){
                              ...
                              * @param param Ids
                              */
                              public void setIds(com.sforce.soap.partner.ID[] param){
                             ...
                             */
                             public void addIds(com.sforce.soap.partner.ID param){
                                   if (localIds == null){
                                   localIds = new com.sforce.soap.partner.ID[]{};
                                   }
                                        ...
                                        xmlWriter.writeStartElement("fieldList");
                                          ...
                                          if (localFieldList==null){
                                              // write the nil attribute
                                                     ...
                                                     throw new org.apache.axis2.databinding.ADBException("fieldList cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localFieldList);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com",
                                        ...
                                        if (localFieldList != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localFieldList));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("fieldList cannot be null!!");
                                        }
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"retrieve".equals(type)){
                                ...
                                return (Retrieve)com.sforce.soap.partner.sobject.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list3 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:partner.soap.sforce.com","fieldList").equals(reader.getName())){
                                    ...
                                    list3.add(com.sforce.soap.partner.ID.Factory.parse(reader));
                                                        ...
                                                        object.setIds((com.sforce.soap.partner.ID[])
