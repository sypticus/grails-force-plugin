        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                        ...
                        /**
                        * field for MergedRecordIds
                        * This was an Array!
                        */

                        
                                    protected com.sforce.soap.partner.ID[] localMergedRecordIds ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localMergedRecordIdsTracker = false ;
                           ...
                           * @return com.sforce.soap.partner.ID[]
                           */
                           public  com.sforce.soap.partner.ID[] getMergedRecordIds(){
                               return localMergedRecordIds;
                           }
                              ...
                              /**
                               * validate the array for MergedRecordIds
                               */
                              protected void validateMergedRecordIds(com.sforce.soap.partner.ID[] param){
                             ...
                             /**
                              * Auto generated setter method
                              * @param param MergedRecordIds
                              */
                              public void setMergedRecordIds(com.sforce.soap.partner.ID[] param){
                              
                                   validateMergedRecordIds(param);

                               
                                          if (param != null){
                                             //update the setting tracker
                                             localMergedRecordIdsTracker = true;
                                          } else {
                                             localMergedRecordIdsTracker = false;
                                                 
                                          }
                                      
                                      this.localMergedRecordIds=param;
                              }
                             ...
                             */
                             public void addMergedRecordIds(com.sforce.soap.partner.ID param){
                                   if (localMergedRecordIds == null){
                                   localMergedRecordIds = new com.sforce.soap.partner.ID[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localMergedRecordIds);
                               list.add(param);
                               this.localMergedRecordIds =
                        ...
                        */
                        ...
                        /**
                        * field for UpdatedRelatedIds
                        * This was an Array!
                        */

                        
                                    protected com.sforce.soap.partner.ID[] localUpdatedRelatedIds ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localUpdatedRelatedIdsTracker = false ;
                           ...
                           * @return com.sforce.soap.partner.ID[]
                           */
                           public  com.sforce.soap.partner.ID[] getUpdatedRelatedIds(){
                               return localUpdatedRelatedIds;
                           }
                              ...
                              /**
                               * validate the array for UpdatedRelatedIds
                               */
                              protected void validateUpdatedRelatedIds(com.sforce.soap.partner.ID[] param){
                             ...
                             /**
                              * Auto generated setter method
                              * @param param UpdatedRelatedIds
                              */
                              public void setUpdatedRelatedIds(com.sforce.soap.partner.ID[] param){
                              
                                   validateUpdatedRelatedIds(param);

                               
                                          if (param != null){
                                             //update the setting tracker
                                             localUpdatedRelatedIdsTracker = true;
                                          } else {
                                             localUpdatedRelatedIdsTracker = false;
                                                 
                                          }
                                      
                                      this.localUpdatedRelatedIds=param;
                              }
                             ...
                             * @param param com.sforce.soap.partner.ID
                             */
                             public void addUpdatedRelatedIds(com.sforce.soap.partner.ID param){
                                   if (localUpdatedRelatedIds == null){
                                   localUpdatedRelatedIds = new com.sforce.soap.partner.ID[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localUpdatedRelatedIds);
                               list.add(param);
                               this.localUpdatedRelatedIds =
                             (com.sforce.soap.partner.ID[])list.toArray(
                            new com.sforce.soap.partner.ID[list.size()]);
                                       ...
                                       if (localMergedRecordIds!=null){
                                            for (int i = 0;i < localMergedRecordIds.length;i++){
                                                if (localMergedRecordIds[i] != null){
                                                 localMergedRecordIds[i].serialize(new javax.xml.namespace.QName("urn:partner.soap.sforce.com","mergedRecordIds"),
                                                           factory,xmlWriter);
                                                } else {
                                       ...
                                       if (localUpdatedRelatedIds!=null){
                                            for (int i = 0;i < localUpdatedRelatedIds.length;i++){
                                                if (localUpdatedRelatedIds[i] != null){
                                                 localUpdatedRelatedIds[i].serialize(new javax.xml.namespace.QName("urn:partner.soap.sforce.com","updatedRelatedIds"),
                                                           factory,xmlWriter);
                                                } else {
                             ...
                             if (localMergedRecordIds!=null) {
                                 for (int i = 0;i < localMergedRecordIds.length;i++){
                                    ...
                                    if (localMergedRecordIds[i] != null){
                                         elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com",
                                                                          "mergedRecordIds"));
                                         elementList.add(localMergedRecordIds[i]);
                                    } else {
                             ...
                             if (localUpdatedRelatedIds!=null) {
                                 for (int i = 0;i < localUpdatedRelatedIds.length;i++){
                                    ...
                                    if (localUpdatedRelatedIds[i] != null){
                                         elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com",
                                                                          "updatedRelatedIds"));
                                         elementList.add(localUpdatedRelatedIds[i]);
                                    } else {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"MergeResult".equals(type)){
                                ...
                                return (MergeResult)com.sforce.soap.partner.sobject.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list5 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:partner.soap.sforce.com","mergedRecordIds").equals(reader.getName())){
                                
                                    
                                    
                                    // Process the array and step past its final element's end.
                                    list3.add(com.sforce.soap.partner.ID.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone3){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("urn:partner.soap.sforce.com","mergedRecordIds").equals(reader.getName())){
                                                                    list3.add(com.sforce.soap.partner.ID.Factory.parse(reader));
                                                        ...
                                                        object.setMergedRecordIds((com.sforce.soap.partner.ID[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:partner.soap.sforce.com","updatedRelatedIds").equals(reader.getName())){
                                
                                    
                                    
                                    // Process the array and step past its final element's end.
                                    list5.add(com.sforce.soap.partner.ID.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone5){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("urn:partner.soap.sforce.com","updatedRelatedIds").equals(reader.getName())){
                                                                    list5.add(com.sforce.soap.partner.ID.Factory.parse(reader));
                                                        ...
                                                        object.setUpdatedRelatedIds((com.sforce.soap.partner.ID[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                com.sforce.soap.partner.ID.class,
                                                                list5));
