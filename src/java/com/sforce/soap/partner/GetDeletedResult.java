 ...
 */
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        /**
                        * field for DeletedRecords
                        * This was an Array!
                        */

                        
                                    protected com.sforce.soap.partner.DeletedRecord[] localDeletedRecords ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           * @return com.sforce.soap.partner.DeletedRecord[]
                           */
                           public  com.sforce.soap.partner.DeletedRecord[] getDeletedRecords(){
                               return localDeletedRecords;
                           }
                              ...
                              /**
                               * validate the array for DeletedRecords
                               */
                              protected void validateDeletedRecords(com.sforce.soap.partner.DeletedRecord[] param){
                              ...
                              * @param param DeletedRecords
                              */
                              public void setDeletedRecords(com.sforce.soap.partner.DeletedRecord[] param){
                              
                                   validateDeletedRecords(param);

                               
                                          if (param != null){
                                             //update the setting tracker
                                             localDeletedRecordsTracker = true;
                                          } else {
                                             localDeletedRecordsTracker = false;
                                                 
                                          }
                                      
                                      this.localDeletedRecords=param;
                              }
                             ...
                             * @param param com.sforce.soap.partner.DeletedRecord
                             */
                             public void addDeletedRecords(com.sforce.soap.partner.DeletedRecord param){
                                   if (localDeletedRecords == null){
                                   localDeletedRecords = new com.sforce.soap.partner.DeletedRecord[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localDeletedRecords);
                               list.add(param);
                               this.localDeletedRecords =
                             (com.sforce.soap.partner.DeletedRecord[])list.toArray(
                            new com.sforce.soap.partner.DeletedRecord[list.size()]);

                             }
                             

                        /**
                        * field for EarliestDateAvailable
                        */

                        
                                    protected java.util.Calendar localEarliestDateAvailable ;
                           ...
                           */
                           public  java.util.Calendar getEarliestDateAvailable(){
                               return localEarliestDateAvailable;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param EarliestDateAvailable
                               */
                               public void setEarliestDateAvailable(java.util.Calendar param){
                            
                                            this.localEarliestDateAvailable=param;
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       GetDeletedResult.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetDeletedResult",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetDeletedResult",
                                       ...
                                       if (localDeletedRecords!=null){
                                            for (int i = 0;i < localDeletedRecords.length;i++){
                                                if (localDeletedRecords[i] != null){
                                                 localDeletedRecords[i].serialize(new javax.xml.namespace.QName("urn:partner.soap.sforce.com","deletedRecords"),
                                                           factory,xmlWriter);
                                                } else {
                                 ...
                                 for (int i = 0;i < localDeletedRecords.length;i++){
                                    ...
                                    if (localDeletedRecords[i] != null){
                                         elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com",
                                                                          "deletedRecords"));
                                         elementList.add(localDeletedRecords[i]);
                                    } else {
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com",
                                        ...
                                        if (localEarliestDateAvailable != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localEarliestDateAvailable));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("earliestDateAvailable cannot be null!!");
                                        }
    ...
    public static class Factory{
        ...
        */
        public static GetDeletedResult parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetDeletedResult object =
                new GetDeletedResult();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetDeletedResult".equals(type)){
                                ...
                                return (GetDeletedResult)com.sforce.soap.partner.sobject.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:partner.soap.sforce.com","deletedRecords").equals(reader.getName())){
                                
                                    
                                    
                                    // Process the array and step past its final element's end.
                                    list1.add(com.sforce.soap.partner.DeletedRecord.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone1){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("urn:partner.soap.sforce.com","deletedRecords").equals(reader.getName())){
                                                                    list1.add(com.sforce.soap.partner.DeletedRecord.Factory.parse(reader));
                                                        ...
                                                        object.setDeletedRecords((com.sforce.soap.partner.DeletedRecord[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                com.sforce.soap.partner.DeletedRecord.class,
                                                                list1));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:partner.soap.sforce.com","earliestDateAvailable").equals(reader.getName())){
                                
                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setEarliestDateAvailable(
