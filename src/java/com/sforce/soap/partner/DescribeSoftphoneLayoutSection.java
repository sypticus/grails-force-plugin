 ...
 */
        ...
        /* This type was generated from the piece of schema that had
                name = DescribeSoftphoneLayoutSection
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected com.sforce.soap.partner.DescribeSoftphoneLayoutItem[] localItems ;
                                

                           /**
                           * Auto generated getter method
                           * @return com.sforce.soap.partner.DescribeSoftphoneLayoutItem[]
                           */
                           public  com.sforce.soap.partner.DescribeSoftphoneLayoutItem[] getItems(){
                               ...
                               */
                              protected void validateItems(com.sforce.soap.partner.DescribeSoftphoneLayoutItem[] param){
                              ...
                              * @param param Items
                              */
                              public void setItems(com.sforce.soap.partner.DescribeSoftphoneLayoutItem[] param){
                             ...
                             * @param param com.sforce.soap.partner.DescribeSoftphoneLayoutItem
                             */
                             public void addItems(com.sforce.soap.partner.DescribeSoftphoneLayoutItem param){
                                   if (localItems == null){
                                   localItems = new com.sforce.soap.partner.DescribeSoftphoneLayoutItem[]{};
                                   }
                            ...
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localItems);
                               list.add(param);
                               this.localItems =
                             (com.sforce.soap.partner.DescribeSoftphoneLayoutItem[])list.toArray(
                            new com.sforce.soap.partner.DescribeSoftphoneLayoutItem[list.size()]);
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       DescribeSoftphoneLayoutSection.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":DescribeSoftphoneLayoutSection",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                                       ...
                                       if (localItems!=null){
                                            for (int i = 0;i < localItems.length;i++){
                                                if (localItems[i] != null){
                                                 localItems[i].serialize(new javax.xml.namespace.QName("urn:partner.soap.sforce.com","items"),
                                                           factory,xmlWriter);
                                                } else {
    ...
    public static class Factory{
        ...
        */
        public static DescribeSoftphoneLayoutSection parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DescribeSoftphoneLayoutSection object =
                new DescribeSoftphoneLayoutSection();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"DescribeSoftphoneLayoutSection".equals(type)){
                                ...
                                return (DescribeSoftphoneLayoutSection)com.sforce.soap.partner.sobject.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list2 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:partner.soap.sforce.com","entityApiName").equals(reader.getName())){
                                
                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setEntityApiName(
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:partner.soap.sforce.com","items").equals(reader.getName())){
                                
                                    
                                    
                                    // Process the array and step past its final element's end.
                                    list2.add(com.sforce.soap.partner.DescribeSoftphoneLayoutItem.Factory.parse(reader));
                                                        ...
                                                        object.setItems((com.sforce.soap.partner.DescribeSoftphoneLayoutItem[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                com.sforce.soap.partner.DescribeSoftphoneLayoutItem.class,
                                                                list2));
