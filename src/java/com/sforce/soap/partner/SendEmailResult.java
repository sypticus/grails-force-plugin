 ...
 */
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected com.sforce.soap.partner.SendEmailError[] localErrors ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           * @return com.sforce.soap.partner.SendEmailError[]
                           */
                           public  com.sforce.soap.partner.SendEmailError[] getErrors(){
                               ...
                               */
                              protected void validateErrors(com.sforce.soap.partner.SendEmailError[] param){
                              ...
                              * @param param Errors
                              */
                              public void setErrors(com.sforce.soap.partner.SendEmailError[] param){
                             ...
                             * @param param com.sforce.soap.partner.SendEmailError
                             */
                             public void addErrors(com.sforce.soap.partner.SendEmailError param){
                                   if (localErrors == null){
                                   localErrors = new com.sforce.soap.partner.SendEmailError[]{};
                                   }
                            ...
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localErrors);
                               list.add(param);
                               this.localErrors =
                             (com.sforce.soap.partner.SendEmailError[])list.toArray(
                            new com.sforce.soap.partner.SendEmailError[list.size()]);
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       SendEmailResult.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":SendEmailResult",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "SendEmailResult",
    ...
    public static class Factory{
        ...
        */
        public static SendEmailResult parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"SendEmailResult".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SendEmailResult)com.sforce.soap.partner.sobject.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    list1.add(com.sforce.soap.partner.SendEmailError.Factory.parse(reader));
                                                        ...
                                                        object.setErrors((com.sforce.soap.partner.SendEmailError[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                com.sforce.soap.partner.SendEmailError.class,
                                                                list1));
